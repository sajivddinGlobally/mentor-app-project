...
//   bool data;
//   final Datum item;
//   ListingDetailsPage(this.data, this.item, {super.key});
//   @override
...
//                   size: 20,
//                   color: themeMode == ThemeMode.dark ? Color(0xFF1B1B1B) : null,
//                 ),
//               ),
//             ),
//           ),
...
//                   Row(
//                     children: [
//                       Icon(Icons.school, color: Color(0xff9088F1), size: 20.sp),
//                       SizedBox(width: 6.w),
//                       Text(
...
//                           color: Color(0xFF1B1B1B), size: 20.sp),
//                       SizedBox(width: 6.w),
//                       Text(
...
//                             color: Color(0xff9088F1), size: 20.sp),
//                         SizedBox(width: 6.w),
//                         Text(
