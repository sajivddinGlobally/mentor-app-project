...
//       log("FROM=$senderId MY=$myId MSG=$message");
//       // ❌ APNA MESSAGE IGNORE KARO (VERY IMPORTANT)
//       if (senderId == myId) {
...
//       },
//     );
//     log("WebSocket Reconnected & Listening", name: "WEBSOCKET");
//   }
//   @override
...
//     historyData.when(
//       data: (snap) {
//         if (_messages.isEmpty && snap.chat != null) {
//           WidgetsBinding.instance.addPostFrameCallback((_) {
//             if (mounted) {
//               setState(() {
...
class _ChatingPageState extends ConsumerState<ChatingPage>
  ...
  void _handleIncomingMessage(String raw) {
    try {
      ...
      // Don't add if it's our own message (we add it manually in _sendMessage)
  ...
  Widget build(BuildContext context) {
    ...
    // Sync history with local list ONLY ONCE
    historyData.whenData((snap) {
